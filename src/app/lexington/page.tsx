...
const permits = [
  { id: 'B-24-591', address: '9A WASHINGTON ST', date: '2025-07-03', cost: 500000, type: 'Detached ADU' },
  { id: 'B-25-470', address: '31A BERTWELL RD', date: '2025-07-16', cost: 511330, type: 'Detached ADU' },
  { id: 'B-24-1571', address: '18R BACON ST', date: '2025-03-24', cost: 407528, type: 'Detached ADU' },
  { id: 'B-24-1385', address: '33 WOODPARK CIR', date: '2025-12-10', cost: 386684, type: 'Detached ADU' },
  { id: 'B-25-1530', address: '26 DOUGLAS RD', date: '2025-12-23', cost: 250516, type: 'Basement ADU' },
  { id: 'B-25-876', address: '14 RIDGE RD', date: '2025-12-19', cost: 226847, type: 'In-Law Suite' },
  { id: 'B-25-657', address: '20 BIRD HILL RD', date: '2025-07-28', cost: 173376, type: 'In-Law Suite' },
  { id: 'B-25-1488', address: '5A SOLLYS WAY', date: '2025-11-18', cost: 87285, type: 'Basement ADU' },
  { id: 'B-25-701', address: '39 WOODPARK CIR', date: '2025-06-20', cost: 20000, type: 'CR-ADU' },
  { id: 'B-25-442', address: '35 MOON HILL RD', date: '2025-05-22', cost: 4200, type: 'ADU Alteration' },
]
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl font-bold text-white">Lexington ADU Permits</h1>
            <p className="text-gray-400 text-sm">Since Feb 2, 2025</p>
          </div>
        ...
        <div className="flex gap-2 md:gap-4 overflow-x-auto mb-8">
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-green-400">{totalPermits}</div>
            <div className="text-gray-400 text-sm">Approved</div>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-blue-400">${(avgCost / 1000).toFixed(0)}K</div>
            <div className="text-gray-400 text-sm">Avg Cost</div>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-purple-400">${(totalInvestment / 1000000).toFixed(1)}M</div>
            <div className="text-gray-400 text-sm">Total Investment</div>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-yellow-400">{Object.keys(typeBreakdown).length}</div>
            <div className="text-gray-400 text-sm">ADU Types</div>
          </div>
        </div>
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg overflow-hidden">
            <table className="w-full">
              <thead className="bg-gray-800/50">
                <tr>
                  <th className="text-left text-gray-300 p-4">Address</th>
                  <th className="text-left text-gray-300 p-4">Type</th>
                  <th className="text-left text-gray-300 p-4">Cost</th>
              ...
              <tbody>
                {permits.map(p => (
                  <tr key={p.id} className="border-t border-gray-800">
                    <td className="p-4">
                      <div className="text-white">{p.address}</div>
                      <div className="text-gray-500 text-sm">{p.id}</div>
                    </td>
                    <td className="p-4 text-gray-300">{p.type}</td>
                    <td className="p-4 text-gray-300">${p.cost.toLocaleString()}</td>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">Data source: Town of Lexington (lexingtonma.gov)</div>
      </div>
    </div>
  )
}
