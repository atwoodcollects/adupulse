            ...
            <div className="flex items-end gap-3 mb-3">
              ...
              <span className="text-gray-500 text-sm mb-1.5 inline-flex items-center gap-1">
                ...
                <span className="relative group cursor-help">
                  ...
                  <span className="absolute top-full sm:bottom-full sm:top-auto left-1/2 -translate-x-1/2 mt-1.5 sm:mt-0 sm:mb-1.5 px-2.5 py-1.5 text-[10px] text-gray-300 bg-gray-800 border border-gray-700 rounded-lg shadow-xl w-48 text-center opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity z-10">
