...
import permits from '@/data/duxbury_permits.json'
import { PieChart, Pie, Cell, Tooltip, ResponsiveContainer } from 'recharts'

export default function DuxburyPage() {
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-4 sm:mb-6">
          <div>
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">Duxbury ADU Permits</h1>
            <p className="text-text-secondary text-xs sm:text-sm">Data via Town of Duxbury Monthly Permit Reports</p>
          </div>
          <TownNav current="Duxbury" />
        </div>
        ...
        <p className="text-text-muted text-[10px] sm:text-xs mt-3 sm:mt-4 text-center">Data source: Town of Duxbury Monthly Building Permit Reports (2025)</p>
      </div>
    </div>
  )
}
