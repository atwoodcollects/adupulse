    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0c0c0c' }}>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-2 md:gap-4 overflow-x-auto mb-8">
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center"><div className="text-3xl font-bold text-purple-400">${(totalInvestment / 1000000).toFixed(1)}M</div><div className="text-gray-400 text-sm">Total Investment</div></div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center"><div className="text-3xl font-bold text-yellow-400">{Object.keys(typeBreakdown).length}</div><div className="text-gray-400 text-sm">ADU Types</div></div>
        </div>
