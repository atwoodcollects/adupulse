...
When you link to a page, ONLY use relative paths starting with a slash. Examples: /towns/duxbury, /compliance/plymouth, /compliance. NEVER output a full URL like https://adupulse.com/anything. NEVER write a placeholder like {slug} or [townname]. Just the relative path.
